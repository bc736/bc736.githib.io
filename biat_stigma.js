 ...
 var API = new APIConstructor();
	...
	return iatExtension({
		...
		instTemplate: '<div><p align="center" style="font-size:20px; font-family:arial"><br/>' +
				...
				'Go as FAST as you can while being accurate. If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' + 
				...
				categories : [  //As many categories you need.
				{
					...
					title : {
						...
						//If you're using a startStimulus, set here. If not, set the parameter showStimuliWithInst to false (see later below)
						        media : {word : 'mentally disturbed, mental illness, mentally unbalanced, mentally ill'), 
}, 
